...
@objc public protocol ENSideMenuDelegate {
    ...
    optional func sideMenuHomePressed()
}
...
public class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    public var selectedIndex:Int = Int()
...
*/
    ...
    */
    ...
    public func homeBtnTapped() {
       self.delegate?.sideMenuHomePressed?()
    ...
    */
    ...
    public func selectedIndexOfMenuItem() -> Int {
