...
class DTIAnimWp8: DTIAnimProtocol {
    ...
    private let animationDuration = CFTimeInterval(4.15)//7.15
    ...
    func needLayoutSubviews() {
        ...
        let ballSize = CGFloat(self.owner.bounds.width / 7)
        //
        ...
        for var index = 0; index < ballCount; ++index {
            ...
            layerBall.backgroundColor? = UIColor.navBarColor().CGColor
    ...
    func startActivity() {
        ...
        //let delays = [CFTimeInterval(1.56), CFTimeInterval(0.31), CFTimeInterval(0.62), CFTimeInterval(0.94), CFTimeInterval(1.25), CFTimeInterval(1.56), CFTimeInterval(1.87), CFTimeInterval(2.18)]
       // let delays = [CFTimeInterval(2.41), CFTimeInterval(0.31), CFTimeInterval(0.62), CFTimeInterval(0.94), CFTimeInterval(1.25), CFTimeInterval(1.56), CFTimeInterval(1.87), CFTimeInterval(2.18)]
        let delays = [CFTimeInterval(1.27), CFTimeInterval(0.21), CFTimeInterval(0.42), CFTimeInterval(0.64), CFTimeInterval(0.85), CFTimeInterval(1.06)]
        //CFTimeInterval(1.27), CFTimeInterval(1.46) -- 1st 1.67
        ...
        for var index = 0; index < ballCount; ++index {
            ...
            rotationsValues.append(CGFloat(rotationsValues[rotationsValues.count-1]) + CGFloat(M_PI*(300.0-180.0)/180.0))//300.0
            rotationsValues.append(CGFloat(rotationsValues[rotationsValues.count-1]) + CGFloat(M_PI*(410.0-300.0)/180.0))//410
            rotationsValues.append(CGFloat(rotationsValues[rotationsValues.count-1]) + CGFloat(M_PI*(645.0-410.0)/180.0))//645
            rotationsValues.append(CGFloat(rotationsValues[rotationsValues.count-1]) + CGFloat(M_PI*(770.0-645.0)/180.0))//770
            rotationsValues.append(CGFloat(rotationsValues[rotationsValues.count-1]) + CGFloat(M_PI*(900.0-770.0)/180.0))//900
