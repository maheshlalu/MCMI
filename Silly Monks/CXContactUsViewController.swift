//
//  CXContactUsViewController.swift
//  Silly Monks
//
...
class CXContactUsViewController: UIViewController,UITextFieldDelegate {
    ...
    func customizeHeaderView() {
        ...
        button.addTarget(self, action: #selector(CXContactUsViewController.backAction), forControlEvents: .TouchUpInside)
    ...
    func addAccessoryViewToField(mTextField:UITextField) {
        ...
        let clearBtn = UIBarButtonItem.init(title: "Clear", style: UIBarButtonItemStyle.Bordered, target: self, action: #selector(CXContactUsViewController.clearNumPadAction))
        let flexSpace = UIBarButtonItem.init(barButtonSystemItem: UIBarButtonSystemItem.FlexibleSpace, target: nil, action:nil)
        let doneBtn = UIBarButtonItem.init(title:"Done", style: UIBarButtonItemStyle.Done, target: self, action: #selector(CXContactUsViewController.doneNumberPadAction))
